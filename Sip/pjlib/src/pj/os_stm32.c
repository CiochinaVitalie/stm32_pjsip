...
//#  include "../../../FreeRTOS-POSIX/include/FreeRTOS_POSIX/semaphore.h"
#endif

#if defined(PJ_HAS_THREADS)
//#  include "../../../FreeRTOS-POSIX/include/FreeRTOS_POSIX/pthread.h"
#endif
...
#define THIS_FILE   "os_core_stm32.c"
